...
dingding_token='xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx'
...
class aliyunecs:
	...
	def get_sys_info(self,key, secret, zone,page):
	...
	def main(self):
		for zone in zones:
			for page in (1,2,3,4,5):
				self.get_sys_info(key,secret,zone,page)
		a="\n".join(self.expire_ecs)
		self.dd(a)
